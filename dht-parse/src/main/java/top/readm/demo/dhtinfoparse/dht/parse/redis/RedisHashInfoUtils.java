package top.readm.demo.dhtinfoparse.dht.parse.redis;
...
public class RedisHashInfoUtils {
    ...
    //beinfo Id
    private final String btInfoIdSTRING="btInfoIdString";
    ...
    public void addCheckedInfo(String infohash){
        BoundSetOperations<String,String> unreliableInfoSetOps=redisTemplate.boundSetOps(checkedInfoSETKEY);
        unreliableInfoSetOps.add(infohash);
    }
     ...
     * @return
     */
    public long getBtInfoIdFromRedis(){
        BoundValueOperations<String, String>  btInfoIdOps=redisTemplate.boundValueOps(btInfoIdSTRING);
        long id=btInfoIdOps.increment();
        return id;
    }
